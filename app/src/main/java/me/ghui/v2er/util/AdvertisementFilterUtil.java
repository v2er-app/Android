...
public class AdvertisementFilterUtil {
    ...
    public static String clearAdvertisementDivJs(Context context){
        ...
        for(int i=0;i<adDivs.length;i++){
            js.append("var adDiv").append(i).append("= document.getElementsByClassName('").append(adDivs[i]).append("');if(adDiv").append(i).append(" != null)adDiv").append(i).append(".parentNode.removeChild(adDiv").append(i).append(");");
        }
        return js.toString();
    }
}
